...
class DataVisualizer:
    ...
    def plot_temp_distribution(self, save_path=None, show=True):
        """
        Plot histogram of temperature distribution.
        
        Args:
            save_path (str, optional): Path to save the figure.
            show (bool): If False, do not display; close after save (for headless/workers).
        """
    ...
    def plot_rainfall_by_location(self, top_n=10, save_path=None, show=True):
        """
        ...
        Args:
            ...
            save_path (str, optional): Path to save the figure.
            show (bool): If False, do not display; close after save.
        """
    ...
    def plot_temp_trends(self, sample_size=1000, save_path=None, show=True):
        """
    ...
    def plot_correlation_heatmap(self, save_path=None, show=True):
        """
    ...
    def plot_rainy_vs_dry_days(self, save_path=None, show=True):
        """
...
def generate_plot(args):
    """
    Worker for multiprocessing: generate one plot. args is (plot_name, df, save_path).
    Must be top-level for pickling.
    """
    plot_name, df, save_path = args
    viz = DataVisualizer(df)
    if plot_name == 'temp_distribution':
        viz.plot_temp_distribution(save_path=save_path, show=False)
    elif plot_name == 'rainfall_by_location':
        viz.plot_rainfall_by_location(save_path=save_path, show=False)
    elif plot_name == 'temp_trends':
        viz.plot_temp_trends(save_path=save_path, show=False)
    elif plot_name == 'correlation_heatmap':
        viz.plot_correlation_heatmap(save_path=save_path, show=False)
    elif plot_name == 'rainy_vs_dry_days':
        viz.plot_rainy_vs_dry_days(save_path=save_path, show=False)
    return save_path
